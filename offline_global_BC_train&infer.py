...
test1.to_netcdf('test_global_nobc_train&implement.nc')
test2.to_netcdf('test_global_0pad_train&implement.nc')
test3.to_netcdf('test_global_rpad_train&implement.nc')